...
export const modules: Module[] = [
  ...
  },
  {
    ...
    track: 'fundamentos',
    sections: [
      { id: 'estructura-y-especificidad', title: 'Estructura y especificidad', file: '01-estructura-y-especificidad' },
      { id: 'system-prompts-y-few-shot', title: 'System prompts y few-shot', file: '02-system-prompts-y-few-shot' },
      { id: 'razonamiento-y-refinamiento', title: 'Razonamiento y refinamiento', file: '03-razonamiento-y-refinamiento' },
      { id: 'patrones-y-conversaciones', title: 'Patrones y conversaciones', file: '04-patrones-y-conversaciones' },
      { id: 'output-errores-y-biblioteca', title: 'Output, errores y biblioteca', file: '05-output-errores-y-biblioteca' },
    ],
    toc: [
      { id: 'estructura-y-especificidad', label: 'Estructura y especificidad' },
      { id: 'system-prompts-y-few-shot', label: 'System prompts y few-shot' },
      { id: 'razonamiento-y-refinamiento', label: 'Razonamiento y refinamiento' },
      { id: 'patrones-y-conversaciones', label: 'Patrones y conversaciones' },
      { id: 'output-errores-y-biblioteca', label: 'Output, errores y biblioteca' },
    ],
  },
  {
